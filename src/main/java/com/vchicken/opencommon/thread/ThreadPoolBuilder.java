package com.vchicken.opencommon.thread;
...
public class ThreadPoolBuilder {
    ...
    private static ThreadPoolExecutor build(ThreadPoolBuilder builder) {
        ...
        workQueue = requireNonNullElseGet(builder.workQueue, () -> (corePoolSize <= 0) ? new SynchronousQueue<Runnable>() : new LinkedBlockingQueue<Runnable>());
    ...
    public static <T> T requireNonNullElseGet(T obj, Supplier<? extends T> supplier) {
        return obj != null ? obj : requireNonNull((requireNonNull(supplier, (String) "supplier")).get(), "supplier.get()");
    }
